          ...
          <b-col cols="12" md="6">
            <div class="d-flex align-items-center justify-content-end">
              <b-form-input
                ...
                placeholder="Search..."
              />
              <b-button variant="primary" :to="{ name: 'apps-country-add' }">
      ...
      >
        ...
        <template #cell(actions)="data">
          ...
          >
            ...
            <b-dropdown-item
              :to="{ name: 'apps-country-edit', params: { id: data.item.id } }"
            >
...
import AreasListFilters from "./CountryListFilters.vue";
      ...
      editStatus: (data) => {
        ...
        const isTrueSet =
          status == String(status ? true : false)
            ...
            : false;
        store
          .dispatch("app-country/updateStatus", { status: isTrueSet, id })
          .then((response) => {
            toast({
              component: ToastificationContent,
              props: {
                title: `The country ${name} was update status correctly`,
